...
public final class OSCSharedPreference extends SharedPreferenceUtil {
    ...
    public String getUserId(){
        return getString("user_id","1");
    }

    public Boolean getBooleanUserId(){
        return getBoolean(getUserId(),false);
    }
    ...
    public void putUserName(String name){
     ...
     public String getTokenHead(){
         return getString("tokenHead", "");
     }

     public void putTokenHead(String tokenHead){
         if (TextUtils.isEmpty(tokenHead)) {
             return;
         }
         put("tokenHead", tokenHead);
     }

     public void putMapStyle(String style){
