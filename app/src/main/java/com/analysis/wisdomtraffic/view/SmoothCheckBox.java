...
import com.analysis.wisdomtraffic.utils.CompatUtils;
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void drawBorder(Canvas canvas) {
        ...
        canvas.drawCircle(mCenterPoint.x, mCenterPoint.y, radius * mFloorScale-3, mFloorPaint);
    }
